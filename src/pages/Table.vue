    ...
    <div class="q-pa-md">
        ...
        >
            <template v-slot:top>
                ...
                <q-btn color="positive" @click="createDialog = true" icon="add" size="sm"/>
                <q-space/>
        ...
        <q-dialog v-model="deleteDialog" transition-show="flip-down" transition-hide="flip-up">
            <q-card style="width: 500px; max-width: 80vw;">
                ...
                <q-card-section style="padding-top: 16px;">
                    <p class="text-body2">Are you sure you want to delete the post "<span class="text-deep-orange">{{ details.title }}</span>"? </p>
                </q-card-section>
                <q-card-actions align="right">
